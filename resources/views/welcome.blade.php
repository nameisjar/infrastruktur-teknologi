<x-default-layout>
        ...
        <div class="container px-6 py-16 mx-auto">
            <div class="items-center lg:flex">
                        ...
                        <div
                            ...
                            <h2 class="mb-0" id="flush-headingOne">
                                <button
                                    ...
                                    Visi
                                    <span
                                        class="-mr-1 ml-auto h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-500 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                ...
                <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                    <div id="carouselExampleSlidesOnly" class="relative" data-te-carousel-init data-te-ride="carousel">
                        <!--Carousel items-->
                        <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                            <!--First item-->
                            <div class="relative float-left -mr-[100%] w-full transition-transform duration-[1000ms] ease-in-out motion-reduce:transition-none"
                                data-te-carousel-item data-te-carousel-active>
                                <img src="https://mdbcdn.b-cdn.net/img/new/slides/041.webp" class="block w-full"
                                    alt="Wild Landscape" />
                            </div>
                            <!--Second item-->
                            <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[1000ms] ease-in-out motion-reduce:transition-none"
    ...
    <div class="container p-6 px-6 mx-auto bg-white dark:bg-gray-800">
        <div class="mb-16 text-center">
            <p
                class="capitalize text-xl font-semibold leading-8 tracking-tight text-gray-800 dark:text-white sm:text-2xl">
                Mata Kuliah
            </p>
            <h2 class="mt-2 text-base font-semibold tracking-wide text-gray-500">
                Mata kuliah yang diampu oleh Laboratorium Infrastruktur Teknologi
            </h2>
        </div>
        ...
        <div class="grid-cols-1 sm:grid md:grid-cols-4">
            <div
                ...
                <div class="p-6 max-w-xs transition duration-300 ease-in-out hover:scale-105">
                    ...
                    <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                        Mata kuliah ini mempelajari prinsip, protokol, dan teknologi yang digunakan dalam menghubungkan
                        dan mengelola jaringan komputer modern.
                    </p>
                </div>
            </div>
            <div
                ...
                <div class="p-6 max-w-xs transition duration-300 ease-in-out hover:scale-105">
                    ...
                    <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                        Mata kuliah ini fokus pada pemahaman sistem operasi, manajemen sumber daya, dan interaksi antara
            ...
            <div
                ...
                <div class="p-6 max-w-xs transition duration-300 ease-in-out hover:scale-105">
                    ...
                    <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                        Mata kuliah ini mengajarkan tentang konfigurasi, manajemen, dan pengoperasian perangkat jaringan
                        untuk mengarahkan dan mengalihkan lalu lintas data.
                    </p>
                </div>
            </div>
            <div
                ...
                <div class="p-6 max-w-xs transition duration-300 ease-in-out hover:scale-105">
                    ...
                    <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                        Mata kuliah ini membahas perencanaan, pengembangan, dan pemeliharaan jaringan komputer, termasuk
                        strategi desain dan manajemen yang efisien.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            <div class="text-center">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Blog
                </h1>
