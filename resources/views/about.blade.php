    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            ...
            <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
                Laboratorium Infrastruktur Teknologi merupakan salah satu laboratorium yang berada di Fakultas Ilmu
                ...
                <div class="h-[32rem] bg-gray-100 dark:bg-gray-800">
                    <div class="container px-6 py-10 mx-auto">
                        ...
                        <p class="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                            Kepala Laboratorium bertanggung jawab mengelola operasi laboratorium, mengawasi staf, serta
                            memastikan kepatuhan protokol keamanan.
                        </p>
                    </div>
                </div>
                ...
                <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16">
                        <div class="flex flex-col items-center">
                            <img class="object-cover w-96 h-96 aspect-square p-4 border sm:p-6 rounded-xl dark:border-gray-700"
                                src="images/pak_priza.png"
                                alt="dosen">
                            <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                                Priza Pandunata, S.Kom., M.Sc.
                            </h1>

                            <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Kepala Laboratorium</p>
                ...
                <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="/images/rendy.png"
                                alt="">
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="images/maulida.png"
                                alt="maulida">
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="images/sahrul.png"
                                alt="sahrul">
            ...
            <section class="bg-white dark:bg-gray-900">
                ...
                <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="images/farah.png"
                                alt="farah">
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="images/muiz.png"
                                alt="muiz">
                            <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="images/maretha.png"
                                alt="mareta">
                            <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                                Maretha Nur Azizah
                            </h1>
