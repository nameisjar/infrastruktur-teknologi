    ...
    <svg class="w-7 h-7 transition duration-200 ease-in-out hover:-rotate-45" viewBox="0 0 24 24" fill="none"
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <g opacity="0.16">
                ...
                <path opacity="0.16" d="M19.5371 6.61768C19.7085 6.8291 19.8628 7.03482 20.0114 7.24053"
                    stroke="#000000" stroke-width="0.5" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round"></path>
                <g opacity="0.16">
                    <path opacity="0.16"
            ...
            <path d="M20.5313 6.31439C19.8913 5.07439 18.8513 4.02867 17.6113 3.38867" stroke="#008EE6"
                stroke-width="0.75" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
            <path
            ...
            <defs>
                ...
                <radialGradient id="paint45_radial" cx="0" cy="0" r="1"
                    gradientUnits="userSpaceOnUse" gradientTransform="translate(16.2658 5.47137) scale(2.90715)">
                ...
                <radialGradient id="paint47_radial" cx="0" cy="0" r="1"
                    gradientUnits="userSpaceOnUse" gradientTransform="translate(12.1646 4.75945) scale(3.94219)">
                    <stop stop-color="white" stop-opacity="0.5"></stop>
                    <stop offset="1" stop-color="white" stop-opacity="0"></stop>
                </radialGradient>
            </defs>
