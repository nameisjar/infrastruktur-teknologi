            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <x-footer-partial-categories />
                    </div>

                    <div>
                        <h3 class="text-gray-700 uppercase dark:text-white">Media</h3>
                        <a href="https://sister.unej.ac.id/"
                            class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Sister Unej</a>
                        <a href="https://mmp.unej.ac.id/login/index.php"
                            class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">MMP</a>
                        <a href="https://ilkom.unej.ac.id/"
                            class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Fasilkom</a>
                        <a href="https://unej.ac.id/"
                            class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Universitas
                            Jember</a>
                    </div>
